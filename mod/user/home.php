...
<div class="jumbotron" style="background-color:#FFFFFF; margin-top:70px; padding:30px;">
	<div class="container" >
	  <h3 style="margin:0px; margin-bottom:10px;">Selamat Datang Di SICAPIL !</h3>
	  <div>
...
<!-- ini home user <a href='config/proses_login.php?op=logout'>KELUAR</a> -->